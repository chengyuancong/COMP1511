...
static void testSingleList (void) {
    ...
    TEST (l->head == NULL,
        "single element list: NULL head pointer");
        
    TEST (mem_address_is_poisoned (n),
...
static void testDoubleList (void) {
    ...
    TEST (l->head == n2,
        "2 element list @ head: head pointer");
        
    TEST (l->head->value == 42,
        "2 element list @ head: head value");
    
    TEST (l->head->next == NULL,
        "2 element list @ head: head next pointer");
